...
\begin{frame}{Momentum Distribution of Each Particle}
  ...
  (same 88-file, 4.13M-event, 5.79M-hit MinBias2026 sample; log-log
  axes, histograms normalized to unit area). This steeply-falling real
  spectrum is what the per-particle ADC calibration curves are weighted
  by.
\end{frame}
