...
\item \textbf{Summary rows mixed into the event tree.} Convenient, but easy to misuse in downstream analysis.
\item \textbf{Naming inconsistencies.} The threshold-5 quantity is stored through a method named as if it were an 80-photoelectron threshold.
